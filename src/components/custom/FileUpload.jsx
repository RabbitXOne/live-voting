 ...
 * @param {string} [props.invalidText='No valid files were dropped'] The error message displayed when invalid files are dropped.
...
const FileUpload = ({
    ...
    invalidText = 'No valid files were dropped',
